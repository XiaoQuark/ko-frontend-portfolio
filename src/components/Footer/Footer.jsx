      ...
      <div className="footer-container container">
        ...
        <div className="footer-social">
          <a
            ...
            target="_blank"
          >
            <UilGithub size="1.25rem" color="var(--container-colour)" />
          </a>
          <a
            ...
            target="_blank"
          >
            <UilLinkedin size="1.25rem" color="var(--container-colour)" />
          </a>
          <a
            ...
            target="_blank"
          >
            <UilInstagram size="1.25rem" color="var(--container-colour)" />
          </a>
        </div>
      </div>
      <div>
